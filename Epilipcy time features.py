...
def box_plot(frequen):
    ...
    ax7.set_title('Gama wave comparison')
    ax7.boxplot(data)

    plt.show()

box_plot("gama")
####prediction_timeseries("Set A")
####prediction_timeseries("Set B")
####prediction_timeseries("Set C")
####prediction_timeseries("Set D")
####prediction_timeseries("Set E")
